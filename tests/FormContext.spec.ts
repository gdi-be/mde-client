...
describe('FormContext', () => {
  describe('getValue', () => {
    test('should get simple values', () => {
      ...
      expect(getValue<string>('isoMetadata.description', metadata1)).toBe("wergwergergergergergrge");
    ...
    test('should get nested array values with index', () => {
      ...
      expect(getValue<string>('isoMetadata.services[2].featureTypes[0].columns[0].name', metadata1))
        .toBe("Mein Attribut");
    });
  ...
  describe('getProgress', () => {
    ...
    test('should handle different sections', () => {
      const role: Role = "MdeEditor";
      const sections: Array<'basedata' | 'classification' | 'temp_and_spatial' | 'additional' | 'services'> = [
        'basedata',
        'classification',
        'temp_and_spatial',
        'additional',
